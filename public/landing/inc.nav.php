                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="navbarNav"> 
                            <ul class="navbar-nav"> 
                                ...
                                <li class="nav-item dropdown dropdown-with-icon">
                                    <a href="demo-web-agency-expertise.html" class="nav-link">Solutions</a>
                                    <i class="fa-solid fa-angle-down dropdown-toggle" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false"></i>
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                        <li>
                                            <a href="demo-web-agency-services-details.html">
                                                <div class="submenu-icon-content">
                                                    <span>Solutions For Athletes</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="demo-web-agency-services-details.html">
                                                <div class="submenu-icon-content">
                                                    <span>Solutions For Collectives</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="demo-web-agency-services-details.html">
                                                <div class="submenu-icon-content">
                                                    <span>Solutions For Parents</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="demo-web-agency-services-details.html">
                                                <div class="submenu-icon-content">
                                                    <span>Solutions For Agents</span>
                                                </div>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="nav-item"><a href="demo-web-agency-blog.html" class="nav-link">Podcast</a></li>  
                                <li class="nav-item"><a href="demo-web-agency-people.html" class="nav-link">About Us</a></li> 
                        ...
                        <div class="header-icon"> 
                            <div class="header-button">
                                <a href="demo-web-agency-about.html" class="btn btn-rounded btn-dark-gray btn-medium btn-switch-text btn-box-shadow text-transform-none">
                                    <span>
                                        <span class="btn-double-text" data-text="Signup">Signup</span>
