    ...
    <ul class="list-unstyled d-flex flex-column gap-2 mb-0">
      <li>
        <a class="menu-link <?= $_SERVER['REQUEST_URI'] === '/marketplace' ? 'active' : '' ?>" href="/marketplace">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#0e0e0e" fill="none">
      ...
      <li>
        <a class="menu-link <?= $_SERVER['REQUEST_URI'] === '/deal-builder' ? 'active' : '' ?>" href="/deal-builder">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#0e0e0e" fill="none">
      ...
      <li>
        <a class="menu-link <?= $_SERVER['REQUEST_URI'] === '/campaign-builder' ? 'active' : '' ?>" href="/campaign-builder">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#0e0e0e" fill="none">
      ...
      <li>
        <a class="menu-link <?= $_SERVER['REQUEST_URI'] === '/messenger' ? 'active' : '' ?>" href="/messenger">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#0e0e0e" fill="none">
      ...
      <li>
        <a class="menu-link <?= $_SERVER['REQUEST_URI'] === '/favorites' ? 'active' : '' ?>" href="/favorites">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#0e0e0e" fill="none">
      ...
      <li>
        <a class="menu-link <?= $_SERVER['REQUEST_URI'] === '/financial-literacy' ? 'active' : '' ?>" href="/financial-literacy">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#0e0e0e" fill="none">
      ...
      <li>
        <a class="menu-link <?= $_SERVER['REQUEST_URI'] === '/recruiting' ? 'active' : '' ?>" href="/recruiting">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#0e0e0e" fill="none">
      ...
      <li>
        <a class="menu-link <?= $_SERVER['REQUEST_URI'] === '/agency' ? 'active' : '' ?>" href="/agency">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#0e0e0e" fill="none">
      ...
      <li>
        <a class="menu-link <?= $_SERVER['REQUEST_URI'] === '/data-services' ? 'active' : '' ?>" href="/data-services">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#0e0e0e" fill="none">
      ...
      <li>
        <a class="menu-link <?= $_SERVER['REQUEST_URI'] === '/collectives' ? 'active' : '' ?>" href="/collectives">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#0e0e0e" fill="none">
